...
def log_chat_trace(*, user_id: str, user_role: str, query: str, response: str,
    ...
    experience_id = usage.get("experience_id")
    ...
    doc = {
        ...
        "cost_usd": cost_usd,
        # Links this trace row back to the self-refining experience record
        # (see app/agents/self_refining.py) so a thumbs up/down given on a
        # restored chat history message can still find the right record.
